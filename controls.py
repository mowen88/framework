...
class Controls(State):
	def __init__(self, game):
		...
		# bg
		self.background = self.game.get_image('assets/backgrounds/spots4.png', RES, RES/2)
	...
	def render(self, display):
		...
		self.game.render_text('Controls', WHITE, self.game.bigger_font, (HALF_WIDTH, HEIGHT * 0.2))

		self.render_button('Back', WHITE, BLACK, WHITE, (HALF_WIDTH, HEIGHT *0.8))
